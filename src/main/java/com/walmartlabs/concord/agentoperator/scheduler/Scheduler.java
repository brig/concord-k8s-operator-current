...
public class Scheduler {
    ...
    public Scheduler(AutoScalerFactory autoScalerFactory, KubernetesClient k8sClient, MonitoringClient monitoringClient, AgentClientFactory agentClientFactory) {
